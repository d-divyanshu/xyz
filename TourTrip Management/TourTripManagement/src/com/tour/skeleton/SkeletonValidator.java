...
public class SkeletonValidator {
	public SkeletonValidator() {
		validateClassName("com.tour.util.ServiceProvider");
		validateClassName("com.tour.model.TourPackage");
		validateClassName("com.tour.exception.InvalidTourPackageException");
		validateClassName("com.tour.test.ServiceProviderTest");

		validateMethodSignature(
				"setPackageId:void,getTotalDays:int,setSource:void,setDestination:void,getPackageId:java.lang.String,setTotalDays:void,getPerPersonCost:double,getPackageType:java.lang.String,setPerPersonCost:void,getSource:java.lang.String,setPackageType:void,getDestination:java.lang.String",
				"com.tour.model.TourPackage");
		validateMethodSignature(
				"viewTourPackagesByPackageType:java.util.List,validatePackageType:boolean,viewTourPackagesTypeWise:java.util.Map,countTotalTourPackagesForEachPackageType:java.util.Map,viewTourPackage:com.tour.model.TourPackage",
				"com.tour.util.ServiceProvider");
		validateMethodSignature(
				"test11ValidatePackageTypeWhenIndependent:void,test12ValidatePackageTypeWhenEscorted:void,test13ValidatePackageTypeWhenInvalid:void,test14ViewTourPackageForValidPackageId:void,test15ViewTourPackageForInvalidPackageId:void,test16ViewTourPackagesByPackageType:void,test17ViewTourPackagesByPackageTypeForEmptyList:void,test18ViewTourPackagesTypeWise:void,test19ViewTourPackagesTypeWiseForEmptyList:void,test20CountTotalTourPackagesForEachPackageType:void,test21CountTotalTourPackagesForEachPackageTypeForEmptyList:void",
				"com.tour.test.ServiceProviderTest");
